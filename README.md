# lambdaPO serverless API
The lambdaPO project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=lambdaPO -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.4 -DgroupId=com.lambda -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd lambdaPO
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "LambdaPOApi",
                    "OutputKey": "LambdaPOApi",
